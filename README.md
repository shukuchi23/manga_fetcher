...
> ⚠️
> <br> По умолчанию, программа весь тайтл фасует по 100 глав на архив cbz. 
> <br>Лимит глав можно поменять при запуске, указав флаге '-l(imit)' и <число глав> 

Например,
```bash
python main.py -l 1000
```
...
> ⚠️
> Утилита работает по стратегии до качки: если вышли новые главы для уже скаченной манги, в `downloads/<имя_тайтла>`
...
> ⚠️
> Авторизация требуется только при первом запуске. Cookies сохраняются в файл `browser-state.json`
